...
import {useSearchQuery} from "@framework/product/use-search2";
...
export const ProductGrid: FC<ProductGridProps> = ({className = ""}) => {
    ...
    if (b.indexOf("?") && b.indexOf("?") > 0) {
        path = b.substring(b.indexOf("?")+1)
    }
    const {data, error, isFetching, isLoading, isFetchingNextPage, fetchNextPages} = useSearchQuery({path,branch})
