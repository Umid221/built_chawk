...
export default function ProductPopup() {
	...
	const { slug, images, nameEng, detailsEng, nameAr, detailsAr } = data;
		...
		<div className="rounded-lg bg-white">
			<div className="flex flex-col lg:flex-row w-full md:w-[650px] lg:w-[960px] mx-auto overflow-hidden">
				<div className="flex-shrink-0 flex items-center justify-center w-full lg:w-430px max-h-430px lg:max-h-full overflow-hidden bg-gray-300">
					<img
						src={
							process.env.NEXT_PUBLIC_GET_ATTACHMENT+images[0]?.id ??
							"/assets/placeholder/products/product-thumbnail.svg"
						}
						alt={router.locale==='en'?nameEng:nameAr}
					...
					<div className="pb-5">
						...
						>
							<h2 className="text-heading text-lg md:text-xl lg:text-2xl font-semibold hover:text-black">
								{router.locale==='en'?nameEng:nameAr}
							</h2>
						</div>
						<p className="text-sm leading-6 md:text-body md:leading-7">
							{router.locale==='en'?detailsEng:detailsAr}
						</p>
